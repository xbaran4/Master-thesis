...
With all that said, Kubelet does not do the actual checkpointing itself. As \Cref{fig:criu-calltrace} illustrates, the kubelet will request a checkpoint from the high-level container runtime on the Node, such as containerd or CRI-O.
\begin{figure}[H]
  \begin{center}
