...
By providing such an image, the definition of the container in the Pod is mostly ignored. Nevertheless, if the container runs in the same environment as before the checkpoint, it will continue to run as expected.
