...
\thesissetup{
    ...
    abstract    = {TODO: },
    thanks      = {I would like to thank my advisor RNDr. Lukáš Hejtmánek, Ph.D., for his help and guidance. I would also like to thank my family and friends for supporting me and providing an environment where I could focus on this thesis.},
    bib         = example.bib,
...
\begin{description}
    ...
    \item[Code cell]
    These allow for writing and executing code in a particular language. The type of language depends on the \emph{Kernel} that the Jupyter Notebook server is communicating with. The exact mechanism behind the execution of code in the Notebook is out of the scope of this thesis. 
...
Jupyter Notebook has become widely used in AI research communities. https://cdn.aaai.org/ocs/10349/10349-46093-1-PB.pdf

\section{JupyterLab}
JupyterLab's documentation describes JupyterLab as Jupyter Notebook's sibling\cite{jupyter_lab}. However, referring to it as a sibling might give the impression that JupyterLab is merely an alternative to Jupyter Notebook. In reality, JupyterLab represents a significant advancement, offering a more sophisticated and customizable user interface which can be tailored to different use-cases. JupyterLab retains the core functionalities of Jupyter Notebook, one of which being the document format, but it expands significantly upon them by providing a modular, flexible workspace that supports multiple panels and interactive widgets.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Jupyter Lab's user interface.}
...
\section{JupyterHub in Kubernetes}

\section{KubeSpawner}

\chapter{Checkpoint/Restore in Userspace}

\section{Checkpoint/Restore of containers}
